...
<div class="wrap J_check_wrap">
  <ul class="nav nav-tabs">
     <li><a href="<?php echo U('AdminPost/index');?>">所有官方信息</a></li>
     <li class="active"><a href="<?php echo U('AdminPost/add',array('term'=>empty($term['term_id'])?'':$term['term_id']));?>"  target="_self">添加官方信息</a></li>
  </ul>
      ...
      <table class="table table-bordered">
        ...
        <tr>
          <td>
			...
			<img src='/zzjk/statics/images/icon/upload-pic.png' id='thumb_preview' width='135' height='113' style='cursor:hand' /></a>
			<!-- <input type="button" class="btn" onclick="crop_cut_thumb($('#thumb').val());return false;" value="裁减图片">  -->
            <input type="button"  class="btn" onclick="$('#thumb_preview').attr('src','/zzjk/statics/images/icon/upload-pic.png');$('#thumb').val('');return false;" value="取消图片">
            </div>
			</td>
        </tr>
        <tr>
  ...
  <div class="col-auto">
    <div class="table_full">
      <table class="table table-bordered">
            ...
            <tr>
              <th width="80">价格(区间)</th>
              <td><input type='text' name='post[post_keywords]' id='keywords' value='' style='width:400px'   class='input' placeholder='输入培训价格'>培训价格</td>
            </tr>
           <!--  <tr>
              <th width="80">文章来源</th>
