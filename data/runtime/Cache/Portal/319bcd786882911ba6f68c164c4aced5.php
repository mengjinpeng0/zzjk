...
<div class="wrap J_check_wrap">
  <ul class="nav nav-tabs">
     ...
     <li><a href="<?php echo U('AdminPost/add',array('term'=>empty($term['term_id'])?'':$term['term_id']));?>"  target="_self">添加官方信息</a></li>
      ...
      <table class="table table-bordered">
        ...
        <tr>
          <td>
			...
			<?php if(empty($smeta['thumb'])): ?><img src="/zzjk/statics/images/icon/upload-pic.png" id='thumb_preview' width='135' height='113' style='cursor:hand' />
			<?php else: ?>
