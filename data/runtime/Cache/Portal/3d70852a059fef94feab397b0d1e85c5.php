...
<div class="row">
	<div class="span12" style="margin-top:130px;margin-left:100px;">
	<div id="l-map"></div>
	<div id="result">
		<button id="open">打开</button><button id="close">关闭</button>
	</div>
	<!--城市列表-->
	<div class="sel_container" style="top:80px;"><strong id="curCity">北京市</strong> [<a id="curCityText" href="javascript:void(0)">更换城市</a>]</div>
...
<script type="text/javascript">
	...
	var point = new BMap.Point(121.130566,41.14618);  // 创建点坐标
