                           ...
                           <div class="tabs">
                               ...
                               <div class="tab-content">
                                   <div class="tab-pane active" id="one">
                                        ...
                                        <div class="control-group">
                                          <label class="control-label" for="input-birthday">电话号码</label>
                                          <div class="controls">
                                            <?php echo ((isset($mobile) && ($mobile !== ""))?($mobile):'未填写'); ?>
                                          </div>
                                        </div>

                                   			<div class="control-group">
                                   				<label class="control-label" for="input-birthday">出生日期</label>
                                   				<div class="controls">
                                   					<?php echo ((isset($birthday) && ($birthday !== ""))?($birthday):'未填写'); ?>
                                   				</div>
                                   			</div>
                                   			<div class="control-group">
                                   				<label class="control-label" for="input-user_url">身份证号</label>
                                   				<div class="controls">
                                   					<?php echo ((isset($user_url) && ($user_url !== ""))?($user_url):'未填写'); ?>
                                   				</div>
                                   			</div>
                                   			<div class="control-group">
                                   				<label class="control-label" for="input-signature">家庭住址</label>
                                   				<div class="controls">
                                       ...
                                       <br>
                                       <div class="control-group">
                                          <label class="control-label" for="input-user_nicename">驾考方式</label>
                                          <div class="controls">
                                            <?php echo ((isset($user_activation_key) && ($user_activation_key !== ""))?($user_activation_key):'未选择'); ?>
                                          </div>
                                        </div>

                                        <br>
                                       <div class="control-group">
                                          <label class="control-label" for="input-user_nicename">第三方</label>
                                          <div class="controls">
                                            <?php echo ((isset($score) && ($score !== ""))?($score):'未选择'); ?>
                                          </div>
                                        </div>
